...
public class GameEngine : IEnumerable<GameRound>
{
    ...
    public static int basicWaitTime = 7;
    public static int advancedWaitTime = 8;
    public static int expertWaitTime = 10;
    public static int masterWaitTime = 12;
    public static int eliteWaitTime = 12;
    public static int legendaryWaitTime = 15;
