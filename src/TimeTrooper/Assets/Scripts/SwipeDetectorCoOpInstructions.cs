...
public class SwipeDetectorCoOpInstructions : MonoBehaviour, IEndDragHandler, IPointerDownHandler, IBeginDragHandler, IDragHandler
{
    ...
    private void OnSwipeLeft()
    {
        ...
        GameStateManagerCoOp.instance.ChangeToGetDificulty();
    }
}
